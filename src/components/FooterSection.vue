<template>
  <footer class="bg-gray-100">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      ...
      <p class="mt-8 text-center text-base text-gray-400">&copy; 2022 Gold Cuts, Inc. All rights reserved.</p>
    </div>
  </footer>
</template>
...
const navigation = {
  main: [
    ...
    { name: 'Barbers', href: '#BarberSection' },
    { name: 'Contact', href: '#ContactSection' },
    { name: 'Appointments', href: 'https://booksy.com/en-us/390352_gold-cuts_barber-shop_18229_chicago' },
  ],
  social: [
    {
      name: 'Facebook',
